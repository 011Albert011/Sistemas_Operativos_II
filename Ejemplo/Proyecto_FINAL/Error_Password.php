    ...
    <div class="tm-row">
      ...
      <div class="tm-right">
        <main class="tm-main">
          ...
          <!-- Special Items Page -->
          <div id="usuarios" class="tm-page-content">
          ...
          <!-- login Page -->
            ...
            <div class="tm-black-bg tm-contact-text-container">
              <h2 class="tm-text-primary">Login: Error de Contraseña</h2>
            ...
            <div class="tm-black-bg tm-contact-form-container tm-align-right">
              <form action="Validar_Usu.php" method="POST" id="contact-form">
...
$(document).ready(function() {
    // Detecta la pgina actual y marca el enlace correspondiente como activo
